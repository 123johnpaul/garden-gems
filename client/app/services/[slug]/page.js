  ...
  if (!service) {
    return (
      <div className="text-center py-20">
        <h1 className="text-2xl font-bold">Sorry, We do not offer this service yet</h1>
        <p className="mt-4">Be sure to contact us so we see how we can include it.</p>
        <Link className="mt-4 text-[#0C7769] underline" href="/services">View our available services here</Link>
      </div>
    );
  }
